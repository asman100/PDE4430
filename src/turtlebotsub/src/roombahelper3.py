...
def Target_Position(index, Vacuum3):
    global actseq
    actseq = Mother_seq[index.data]
    
 
def posedata(data, Vacuum3):
...
def autonav():
    ...
    rospy.init_node('RoombaHelper3', anonymous=True)
    Vacuum3 = rospy.Publisher('/turtle3/cmd_vel', Twist, queue_size=10)
    rospy.Subscriber('/Roomba_Helper_3', Int32, Target_Position, Vacuum3 )
    rospy.Subscriber('/turtle3/pose', Pose, posedata, Vacuum3)
