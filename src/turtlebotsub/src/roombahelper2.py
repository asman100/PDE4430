...
def Target_Position(index, Vacuum2):
    global actseq
    actseq = Mother_seq[index.data]
    
 
def posedata(data, Vacuum2):
...
def autonav():
    ...
    rospy.init_node('RoombaHelper2', anonymous=True)
    Vacuum2 = rospy.Publisher('/turtle2/cmd_vel', Twist, queue_size=10)
    rospy.Subscriber('/Roomba_Helper_2', Int32, Target_Position, Vacuum2 )
    rospy.Subscriber('/turtle2/pose', Pose, posedata, Vacuum2)
